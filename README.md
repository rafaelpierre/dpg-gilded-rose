...
* Additionally, results from *texttest_fixture.py* were generated for both **legacy** and **updated** versions, and compared. This was done to confirm that previous logic was preserved.
